...
draft: false
summary: "How I faked being present in college Zoom classes by creating a fake webcam"
images: ["/static/images/twitter-card.png"]
---

Like most people, the pandemic was a formative time for me.

It made me reconsider what I actually wanted to do with my time—and I realized that sitting through Zoom lectures wasn’t always at the top of that list. But there was one problem: my professors required cameras to be on.
